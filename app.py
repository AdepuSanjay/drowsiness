...
def analyze_frame(frame_bytes):
    ...
    if status == "DROWSY":
        ...
        cv2.putText(overlay_frame, "DROWSY DETECTED!", (width//2 - 150, 35), 
                   cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 3)
        cv2.putText(overlay_frame, "WAKE UP!", (width//2 - 80, 65), 
                   cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255, 255, 255), 2)
    else:
        # Green background for awake
        cv2.rectangle(overlay_frame, (0, 0), (width, 50), (0, 255, 0), -1)
        cv2.putText(overlay_frame, f"STATUS: {status}", (width//2 - 100, 30), 
